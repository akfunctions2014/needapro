...
class Account_model extends MY_Model
{
    ...
    {                
         $query = $this->db->query("
            ...
            (SELECT count(*) from account_categories where 
                account_categories.categoryid = lookup.id AND account_categories.accountid = '{$this->session->userdata("accountid")}') as checked
            FROM lookup where parent = 1429189456
        ");
    ...
    public function updatecategories()
    {
        ...
        $this->db->delete("account_categories", ["accountid"=>$this->session->userdata("accountid")]);
        $batch = [];
        ...
        $this->db->insert_batch("account_categories", $batch);
